...
function SpotifyPlaylistDetail({ externalId, onBack, onPlay, onSave, onLike, likedIds }: { externalId: string; onBack: () => void; onPlay: (track: Track) => void; onSave: (track: Track) => void; onLike: (track: Track) => void; likedIds: Set<string> }) {
...
export default function Home() {
  ...
  const togglePlay = () => {
    if (String(currentTrack.id).startsWith("spotify-") && !currentTrack.audio) {
      void spotifyPlayer.togglePlay()?.then(() => setIsPlaying((playing) => !playing));
      return;
    }
